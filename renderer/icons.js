...
(function () {
  ...
  const I = {
    ...
    'calculator': '<rect x="4.5" y="2.5" width="15" height="19" rx="2.2"/><rect x="7.5" y="5.5" width="9" height="3.5" rx="1"/><path d="M8.4 12.8h.01M12 12.8h.01M15.6 12.8h.01M8.4 16.6h.01M12 16.6h.01M15.6 16.6h.01"/>',
